"""添加短故事版本历史字段（PostgreSQL）

Revision ID: add_revision_history_pg
Revises: add_short_story_score_pg
...
revision: str = 'add_revision_history_pg'
down_revision: Union[str, None] = 'add_short_story_score_pg'
