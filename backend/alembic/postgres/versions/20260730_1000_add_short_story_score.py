"""添加短故事AI评分字段（PostgreSQL）

Revision ID: add_short_story_score_pg
Revises: add_short_stories_pg
...
revision: str = 'add_short_story_score_pg'
down_revision: Union[str, None] = 'add_short_stories_pg'
