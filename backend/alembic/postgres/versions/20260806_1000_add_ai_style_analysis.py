"""为章节分析表添加AI味分析字段（PostgreSQL）

Revision ID: add_ai_style_analysis_pg
Revises: add_short_story_key_points_pg
...
revision: str = 'add_ai_style_analysis_pg'
down_revision: Union[str, None] = 'add_short_story_key_points_pg'
