"""为 characters 表添加 current_location 冗余字段（PostgreSQL）

Revision ID: add_char_current_location_pg
Revises: add_tianming_state_pg
...
revision: str = 'add_char_current_location_pg'
down_revision: Union[str, None] = 'add_tianming_state_pg'
