...
Revision ID: add_short_story_key_points_sqlite
Revises: add_book_import_tasks_sqlite
...
revision: str = 'add_short_story_key_points_sqlite'
down_revision: Union[str, None] = 'add_book_import_tasks_sqlite'
